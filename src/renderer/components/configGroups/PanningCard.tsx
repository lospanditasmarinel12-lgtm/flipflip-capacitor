...
class PanningCard extends React.Component {
  ...
  render() {
    const panSinRate = typeof this.props.scene.panSinRate === 'number' ? this.props.scene.panSinRate : (this.props.scene.panSinRate === '' ? '' : 0);
    const panBPMMulti = typeof this.props.scene.panBPMMulti === 'number' ? this.props.scene.panBPMMulti : (this.props.scene.panBPMMulti === '' ? '' : 0);
    const panDuration = typeof this.props.scene.panDuration === 'number' ? this.props.scene.panDuration : (this.props.scene.panDuration === '' ? '' : 0);
    const panDurationMin = typeof this.props.scene.panDurationMin === 'number' ? this.props.scene.panDurationMin : (this.props.scene.panDurationMin === '' ? '' : 0);
    const panDurationMax = typeof this.props.scene.panDurationMax === 'number' ? this.props.scene.panDurationMax : (this.props.scene.panDurationMax === '' ? '' : 0);
    const horizTransLevel = typeof this.props.scene.panHorizTransLevel === 'number' ? this.props.scene.panHorizTransLevel : (this.props.scene.panHorizTransLevel === '' ? '' : 0);
    const horizTransLevelMax = typeof this.props.scene.panHorizTransLevelMax === 'number' ? this.props.scene.panHorizTransLevelMax : (this.props.scene.panHorizTransLevelMax === '' ? '' : 0);
    const horizTransLevelMin = typeof this.props.scene.panHorizTransLevelMin === 'number' ? this.props.scene.panHorizTransLevelMin : (this.props.scene.panHorizTransLevelMin === '' ? '' : 0);
    const vertTransLevel = typeof this.props.scene.panVertTransLevel === 'number' ? this.props.scene.panVertTransLevel : (this.props.scene.panVertTransLevel === '' ? '' : 0);
    const vertTransLevelMax = typeof this.props.scene.panVertTransLevelMax === 'number' ? this.props.scene.panVertTransLevelMax : (this.props.scene.panVertTransLevelMax === '' ? '' : 0);
    const vertTransLevelMin = typeof this.props.scene.panVertTransLevelMin === 'number' ? this.props.scene.panVertTransLevelMin : (this.props.scene.panVertTransLevelMin === '' ? '' : 0);
              ...
              <Grid item xs={12} sm={this.props.sidebar ? 12 : 8}>
                  ...
                  <Grid container alignItems="center">
                    <Grid item xs>
                      <Slider
                        ...
                        min={1}
                        defaultValue={Number(panSinRate)}
                ...
                <FullWidthCollapse in={this.props.scene.panning && this.props.scene.panTF == TF.bpm}>
                  ...
                  <Slider
                    min={1}
                    max={100}
                    defaultValue={Number(panBPMMulti)}
