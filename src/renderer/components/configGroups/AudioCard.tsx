...
import { Collapse, Divider, Fab, FormControlLabel, Grid, Switch, Tooltip, Typography } from "@mui/material";
            ...
            <Grid item xs>
              <Collapse in={!this.props.persist}>
                <div>
                  <FormControlLabel
                    control={
                      <Switch checked={this.props.scene.muteVideoAudio}
                              onChange={this.onBoolInput.bind(this, 'muteVideoAudio')}/>
                    }
                    label="Mute Video Sound"/>
                  <Typography variant="caption" color="textSecondary" display="block">
                    Videos play silently so background app audio isn't interrupted; pair with a scene Audio Track for sound.
                  </Typography>
                </div>
              </Collapse>
            </Grid>
