...
class ImageVideoCard extends React.Component {
  ...
  render() {
    const gifTimingConstant = typeof this.props.scene.gifTimingConstant === 'number' ? this.props.scene.gifTimingConstant : (this.props.scene.gifTimingConstant === '' ? '' : 0);
    const gifTimingMin = typeof this.props.scene.gifTimingMin === 'number' ? this.props.scene.gifTimingMin : (this.props.scene.gifTimingMin === '' ? '' : 0);
    const gifTimingMax = typeof this.props.scene.gifTimingMax === 'number' ? this.props.scene.gifTimingMax : (this.props.scene.gifTimingMax === '' ? '' : 0);
    const videoTimingConstant = typeof this.props.scene.videoTimingConstant === 'number' ? this.props.scene.videoTimingConstant : (this.props.scene.videoTimingConstant === '' ? '' : 0);
    const videoTimingMin = typeof this.props.scene.videoTimingMin === 'number' ? this.props.scene.videoTimingMin : (this.props.scene.videoTimingMin === '' ? '' : 0);
    const videoTimingMax = typeof this.props.scene.videoTimingMax === 'number' ? this.props.scene.videoTimingMax : (this.props.scene.videoTimingMax === '' ? '' : 0);
    const skipVideoStart = typeof this.props.scene.skipVideoStart === 'number' ? this.props.scene.skipVideoStart : (this.props.scene.skipVideoStart === '' ? '' : 0);
    const skipVideoEnd = typeof this.props.scene.skipVideoEnd === 'number' ? this.props.scene.skipVideoEnd : (this.props.scene.skipVideoEnd === '' ? '' : 0);
    const videoVolume = typeof this.props.scene.videoVolume === 'number' ? this.props.scene.videoVolume : (this.props.scene.videoVolume === '' ? '' : 0);
          ...
          <Grid item xs={12}>
            <Collapse in={this.props.scene.imageTypeFilter != IF.stills && this.props.scene.imageTypeFilter != IF.images}>
              <Grid container spacing={1} alignItems="center">
                ...
                <Grid item xs>
                  <Slider
                    defaultValue={Number(videoVolume)}
