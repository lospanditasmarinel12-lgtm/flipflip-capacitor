...
class FadeIOCard extends React.Component {
  ...
  render() {
    const fadeSinRate = typeof this.props.scene.fadeIOSinRate === 'number' ? this.props.scene.fadeIOSinRate : (this.props.scene.fadeIOSinRate === '' ? '' : 0);
    const fadeBPMMulti = typeof this.props.scene.fadeIOBPMMulti === 'number' ? this.props.scene.fadeIOBPMMulti : (this.props.scene.fadeIOBPMMulti === '' ? '' : 0);
    const fadeDuration = typeof this.props.scene.fadeIODuration === 'number' ? this.props.scene.fadeIODuration : (this.props.scene.fadeIODuration === '' ? '' : 0);
    const fadeDurationMin = typeof this.props.scene.fadeIODurationMin === 'number' ? this.props.scene.fadeIODurationMin : (this.props.scene.fadeIODurationMin === '' ? '' : 0);
    const fadeDurationMax = typeof this.props.scene.fadeIODurationMax === 'number' ? this.props.scene.fadeIODurationMax : (this.props.scene.fadeIODurationMax === '' ? '' : 0);
