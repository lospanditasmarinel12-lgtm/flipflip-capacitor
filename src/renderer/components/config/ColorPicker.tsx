      ...
      <Grid container alignItems="center">
        <Grid item sx={{ width: 170 }}>
          <Tooltip disableInteractive title="Pick Color">
            <Fab
              sx={{ backgroundColor: 'common.white', mt: 0, ml: 1, mr: 1, mb: 1, boxShadow: 'none' }}
        ...
        <Grid item xs={12} sm={this.props.sidebar ? 12 : true}>
          <Grid container alignItems="center">
            {COLORS.map((c) =>
              <Grid key={c} item>
                <Fab
                  sx={{ backgroundColor: 'common.white', mr: 0.25, width: (theme) => theme.spacing(2), height: (theme) => theme.spacing(2), minHeight: (theme) => theme.spacing(2), boxShadow: 'none' }}
