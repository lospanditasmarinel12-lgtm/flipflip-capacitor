...
interface GeneralSettingsI {
  ...
  hapticSystemAudio: boolean;
  hapticSystemDeviceId: string;
  hapticMotorIntensities: Record<string, number>;
...
export class GeneralSettings  implements GeneralSettingsI {
  ...
  hapticTransport = 'auto';
  hapticWSEndpoint = 'ws://127.0.0.1:12345';
  hapticSystemAudio = false;
  hapticSystemDeviceId = '';
  hapticMotorIntensities = {} as Record<string, number>;
  nativeAudioPlayback = false;
