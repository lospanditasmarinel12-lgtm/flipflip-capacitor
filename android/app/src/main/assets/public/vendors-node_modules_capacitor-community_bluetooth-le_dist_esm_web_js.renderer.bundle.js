"use strict";
(self["webpackChunkflipflip"] = self["webpackChunkflipflip"] || []).push([["vendors-node_modules_capacitor-community_bluetooth-le_dist_esm_web_js"],{
...
/* harmony import */ var _conversion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./conversion */ "./node_modules/@capacitor-community/bluetooth-le/dist/esm/conversion.js");
/* harmony import */ var _timeout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./timeout */ "./node_modules/@capacitor-community/bluetooth-le/dist/esm/timeout.js");



class BluetoothLeWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_0__.WebPlugin {
    constructor() {
        super(...arguments);
    ...
    onAdvertisementReceived(event) {
        ...
        if (isNew || ((_b = this.requestBleDeviceOptions) === null || _b === void 0 ? void 0 : _b.allowDuplicates)) {
            ...
            const result = {
                ...
                manufacturerData: (0,_conversion__WEBPACK_IMPORTED_MODULE_1__.mapToObject)(event.manufacturerData),
                serviceData: (0,_conversion__WEBPACK_IMPORTED_MODULE_1__.mapToObject)(event.serviceData),
                uuids: (_c = event.uuids) === null || _c === void 0 ? void 0 : _c.map(_conversion__WEBPACK_IMPORTED_MODULE_1__.webUUIDToString),
            };
    ...
    async connect(options) {
        ...
        try {
            ...
            await (0,_timeout__WEBPACK_IMPORTED_MODULE_2__.runWithTimeout)(device.gatt.connect(), timeout, timeoutError);
        }
        catch (error) {
    ...
    async write(options) {
        ...
        if (typeof options.value === 'string') {
            dataView = (0,_conversion__WEBPACK_IMPORTED_MODULE_1__.hexStringToDataView)(options.value);
        }
        else {
            dataView = options.value;
        }
        await (characteristic === null || characteristic === void 0 ? void 0 : characteristic.writeValueWithResponse((0,_conversion__WEBPACK_IMPORTED_MODULE_1__.toArrayBufferDataView)(dataView)));
    }
    async writeWithoutResponse(options) {
        ...
        await (characteristic === null || characteristic === void 0 ? void 0 : characteristic.writeValueWithoutResponse((0,_conversion__WEBPACK_IMPORTED_MODULE_1__.toArrayBufferDataView)(dataView)));
    }
    ...
    async writeDescriptor(options) {
        ...
        await (descriptor === null || descriptor === void 0 ? void 0 : descriptor.writeValue((0,_conversion__WEBPACK_IMPORTED_MODULE_1__.toArrayBufferDataView)(dataView)));
    }
...
//# sourceMappingURL=vendors-node_modules_capacitor-community_bluetooth-le_dist_esm_web_js.renderer.bundle.js.map