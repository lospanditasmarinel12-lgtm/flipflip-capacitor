"use strict";
(self["webpackChunkflipflip"] = self["webpackChunkflipflip"] || []).push([["vendors-node_modules_music-metadata_lib_mp4_MP4Parser_js"],{
...
const SecondsSinceMacEpoch64 = {
    len: 8,
    get: (buf, off) => {
        const secondsSinceUnixEpoch = Number(token_types__WEBPACK_IMPORTED_MODULE_0__.UINT64_BE.get(buf, off)) - 2082844800;
        return new Date(secondsSinceUnixEpoch * 1000);
    }
};
/**
...
class MdhdAtom extends FixedLengthAtom {
    ...
    get(buf, off) {
        const version = token_types__WEBPACK_IMPORTED_MODULE_0__.UINT8.get(buf, off + 0);
        const flags = token_types__WEBPACK_IMPORTED_MODULE_0__.UINT24_BE.get(buf, off + 1);
        switch (version) {
            case 0:
            ...
            case 1:
                return {
                    ...
                    timeScale: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 20),
                    duration: Number(token_types__WEBPACK_IMPORTED_MODULE_0__.UINT64_BE.get(buf, off + 24)),
                    language: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT16_BE.get(buf, off + 32),
                    quality: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT16_BE.get(buf, off + 34)
                };
            default:
                throw new _ParseError_js__WEBPACK_IMPORTED_MODULE_3__.FieldDecodingError('Invalid mdhd version header');
        }
    }
}
/**
...
class MvhdAtom extends FixedLengthAtom {
    ...
    get(buf, off) {
        const version = token_types__WEBPACK_IMPORTED_MODULE_0__.UINT8.get(buf, off);
        const flags = token_types__WEBPACK_IMPORTED_MODULE_0__.UINT24_BE.get(buf, off + 1);
        if (version === 1) {
            ...
            return {
                ...
                timeScale: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 20),
                duration: Number(token_types__WEBPACK_IMPORTED_MODULE_0__.UINT64_BE.get(buf, off + 24)),
                preferredRate: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 32),
                preferredVolume: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT16_BE.get(buf, off + 36),
                // ignore reserved: 10 bytes
                // ignore matrix structure: 36 bytes
                previewTime: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 84),
                previewDuration: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 88),
                posterTime: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 92),
                selectionTime: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 96),
                selectionDuration: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 100),
                currentTime: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 104),
                nextTrackID: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 108)
            };
        }
        // Version 0: 32-bit fields
        return {
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_mp4_MP4Parser_js.renderer.bundle.js.map